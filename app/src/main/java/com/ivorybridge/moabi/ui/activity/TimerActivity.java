...
public class TimerActivity extends AppCompatActivity implements PropertyChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timedActivityViewModel = ViewModelProviders.of(TimerActivity.this).get(TimedActivityViewModel.class);
                            ...
                            handler.post(new Runnable() {
                                ...
                                public void run() {
                                    if (!editText.getText().toString().isEmpty()) {
                                        ...
                                        hideKeyboard(TimerActivity.this);
                                    } else {
                                        editText.clearFocus();
                                        editText.setVisibility(View.INVISIBLE);
                                        editButton.setVisibility(View.VISIBLE);
    ...
    private void save() {
        ...
        if (name.equals(getString(R.string.activity_unknown_title)) && intervalActive == 0) {
