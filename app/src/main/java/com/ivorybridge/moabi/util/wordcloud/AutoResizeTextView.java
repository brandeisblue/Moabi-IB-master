...
public class AutoResizeTextView extends AppCompatTextView {
    ...
    public AutoResizeTextView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        _minTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 24, getResources().getDisplayMetrics());
        ...
        _sizeTester = new SizeTester() {
            ...
            public int onTestSize(final int suggestedSize, final RectF availableSpace) {
                ...
                if (singleLine) {
                    ...
                    StaticLayout.Builder builder = StaticLayout.Builder.obtain(text, 0, text.length(), _paint, _widthLimit);
                    //final StaticLayout layout = new StaticLayout(text, _paint, _widthLimit, Alignment.ALIGN_NORMAL, _spacingMult, _spacingAdd, true);
                    final StaticLayout layout = builder
