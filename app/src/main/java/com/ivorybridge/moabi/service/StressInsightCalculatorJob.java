...
public class StressInsightCalculatorJob extends Job {

    public static final String TAG = "stress_insight_calculator_job";
    ...
    public StressInsightCalculatorJob(Application application) {
    ...
    public static void scheduleJob() {
        new JobRequest.Builder(StressInsightCalculatorJob.TAG)
                .startNow()
