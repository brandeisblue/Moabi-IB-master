...
public class DailyReviewInsightCalculatorDailyJob extends DailyJob {

    public static final String TAG = "daily_review_insight_calculator_daily_job";
    ...
    public DailyReviewInsightCalculatorDailyJob(Application application) {
