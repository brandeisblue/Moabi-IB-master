...
public class UserGoalPeriodicJob extends Job {

    public static final String TAG = "user_goal_periodic_job";
    ...
    public UserGoalPeriodicJob(Application application) {
    ...
    public static void schedulePeriodicJob() {
        jobId = new JobRequest.Builder(UserGoalPeriodicJob.TAG)
