...
public class CheckInDailyJob extends DailyJob {

    public static final String TAG = "check_in_daily_job";
    private Application application;
    private static int jobId;

    public CheckInDailyJob(Application application) {
    ...
    protected DailyJobResult onRunDailyJob(@NonNull Job.Params params) {
        Intent serviceIntent = new Intent(application, CheckInService.class);
