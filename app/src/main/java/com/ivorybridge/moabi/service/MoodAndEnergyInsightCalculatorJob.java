...
public class MoodAndEnergyInsightCalculatorJob extends Job {

    public static final String TAG = "mood_energy_insight_calculator_job";
    ...
    public MoodAndEnergyInsightCalculatorJob(Application application) {
